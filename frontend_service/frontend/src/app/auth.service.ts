...
export class AuthService {
  ...
  public checkAuthentication(): void {
    this.httpClient
      .get<boolean>('http://34.125.30.158:8080/authenticated', {
  ...
  public logout(): void {
    ...
    this.httpClient
      .post(
        'http://34.125.30.158:8080/logout',
        {},
  ...
  public login(): void {
    ...
    const authorizationUrl =
      'http://34.125.30.158:8080/oauth2/authorization/gitlab?redirect_url=http://34.125.30.158:8084/';
